        ...
        {selectedChoice === "manual" && (
          <div className="bg-white shadow rounded-xl p-6 flex text-black">
            ...
            <div className="w-3/4 pl-6">
              ...
              <input type="text" placeholder="Enter Question" className="w-full mb-4 p-2 border rounded" />

              {/* Dynamic Inputs Based on Type */}
              {questionType === "multiple" && (
                <>
                  <input type="text" placeholder="Option A" className="w-full mb-2 p-2 border rounded" />
                  <input type="text" placeholder="Option B" className="w-full mb-2 p-2 border rounded" />
                  <input type="text" placeholder="Option C" className="w-full mb-2 p-2 border rounded" />
                  <input type="text" placeholder="Option D" className="w-full mb-2 p-2 border rounded" />
                  <input type="text" placeholder="Right answer(s)" className="w-full mb-2 p-2 border rounded" />
                </>
              )}
